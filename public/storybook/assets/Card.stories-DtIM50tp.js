...
Features hover effects, optional title, and supports both light and dark themes.`}}},tags:[`autodocs`],argTypes:{title:{control:`text`,description:`Optional title displayed at the top of the card`},children:{control:`text`,description:`Content to display inside the card`}}},s={args:{title:`Card Title`,children:`This is the card content. It can contain any React elements.`}},c={args:{children:`This card has no title, just content.`}},l={args:{title:`Project Card`,children:(0,a.jsxs)(`div`,{children:[(0,a.jsx)(`p`,{className:`text-gray-600 dark:text-gray-300 mb-4`,children:`A modern, responsive personal resume website built with Next.js 14, TypeScript, and Tailwind CSS.`}),(0,a.jsxs)(`div`,{className:`flex gap-2`,children:[(0,a.jsx)(`span`,{className:`px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded text-sm`,children:`Next.js`}),(0,a.jsx)(`span`,{className:`px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded text-sm`,children:`TypeScript`}),(0,a.jsx)(`span`,{className:`px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded text-sm`,children:`Tailwind`})]})]})}},u={render:()=>(0,a.jsxs)(`div`,{className:`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl`,children:[(0,a.jsx)(n,{title:`Card 1`,children:(0,a.jsx)(`p`,{className:`text-gray-600 dark:text-gray-300`,children:`First card content`})}),(0,a.jsx)(n,{title:`Card 2`,children:(0,a.jsx)(`p`,{className:`text-gray-600 dark:text-gray-300`,children:`Second card content`})}),(0,a.jsx)(n,{title:`Card 3`,children:(0,a.jsx)(`p`,{className:`text-gray-600 dark:text-gray-300`,children:`Third card content`})})]})},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    title: "Card Title",
