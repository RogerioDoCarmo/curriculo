...
- Name: cookie-consent.spec.ts >> Cookie Consent Banner >> Customize flow >> should have essential cookies always enabled
- Location: tests/e2e/cookie-consent.spec.ts:204:9
...
Locator: getByRole('dialog', { name: /cookies|privacidade/i }).getByRole('checkbox', { name: /essenciais|essential/i })
Expected: checked
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: /cookies|privacidade/i }).getByRole('checkbox', { name: /essenciais|essential/i })
