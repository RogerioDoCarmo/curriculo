...
- Name: cookie-consent.spec.ts >> Cookie Consent Banner >> First visit >> should show essential and analytics cookie categories
- Location: tests/e2e/cookie-consent.spec.ts:47:9
...
Locator: getByRole('dialog').getByText(/essential|essencial/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog').getByText(/essential|essencial/i)
