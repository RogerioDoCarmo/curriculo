...
- Name: cookie-consent.spec.ts >> Cookie Consent Banner >> Customize flow >> should allow toggling analytics preference
- Location: tests/e2e/cookie-consent.spec.ts:216:9
...
Locator: getByRole('dialog', { name: /cookies|privacidade/i }).getByRole('checkbox', { name: /analíticos|analytics/i })
Expected: checked
Timeout: 5000ms
