...
- Name: cookie-consent.spec.ts >> Cookie Consent Banner >> Multi-language support >> should display banner in Portuguese
- Location: tests/e2e/cookie-consent.spec.ts:395:9
...
Error: strict mode violation: getByRole('dialog').getByText(/cookies/i) resolved to 5 elements:
    1) <h2 id="cookie-consent-title" class="mb-4 text-xl font-bold text-gray-900 dark:text-gray-100">Este site usa cookies</h2> aka getByRole('heading', { name: 'Este site usa cookies' })
    2) <p class="mb-6 text-sm text-gray-600 dark:text-gray-300">Usamos cookies essenciais para o funcionamento do…</p> aka getByText('Usamos cookies essenciais')
    3) <p class="text-sm font-medium text-gray-900 dark:text-gray-100">Cookies Essenciais</p> aka getByText('Cookies Essenciais', { exact: true })
    4) <p class="text-sm font-medium text-gray-900 dark:text-gray-100">Cookies de Análise</p> aka getByText('Cookies de Análise', { exact: true })
        ...
        - generic [ref=e4]:
            - navigation "Main navigation" [ref=e5]:
                - link "Início" [ref=e6] [cursor=pointer]:
                    - /url: "#home"
                - link "Projetos" [ref=e7] [cursor=pointer]:
                    - /url: "#projects"
                - link "Experiência" [ref=e8] [cursor=pointer]:
                    - /url: "#experience"
                - link "Habilidades" [ref=e9] [cursor=pointer]:
                    - /url: "#skills"
                - link "Contato" [ref=e10] [cursor=pointer]:
                    - /url: "#contact"
                - link "Usado neste site" [ref=e11] [cursor=pointer]:
            ...
            - generic [ref=e26]:
                - generic [ref=e27]:
                    ...
                    - generic [ref=e37]:
                        ...
                        - link "Avaliação da qualidade das medidas e posicionamento GNSS em smartphones Android" [ref=e40] [cursor=pointer]:
                            - /url: http://hdl.handle.net/11449/243430
                            - img [ref=e41]
                            - text: Avaliação da qualidade das medidas e posicionamento GNSS em smartphones Android
                        - link "Baixar dissertação de mestrado em PDF" [ref=e46] [cursor=pointer]:
                    ...
                    - generic [ref=e55]:
                        - link "Ver Meu Trabalho" [ref=e56] [cursor=pointer]:
                            - /url: "#projects"
                        - link "Entre em Contato" [ref=e57] [cursor=pointer]:
                            - /url: mailto:contato@rogeriodocarmo.com
                            - img [ref=e58]
                            - text: Entre em Contato
                    - paragraph [ref=e61]:
                        - link "contato@rogeriodocarmo.com" [ref=e62] [cursor=pointer]:
                            - /url: mailto:contato@rogeriodocarmo.com
            ...
            - generic [ref=e478]:
                ...
                - generic [ref=e482]:
                    ...
                    - generic [ref=e486]:
                        ...
                        - link "contato@rogeriodocarmo.com" [ref=e488] [cursor=pointer]:
                            - /url: mailto:contato@rogeriodocarmo.com
        ...
        - generic [ref=e502]:
            - generic [ref=e503]:
                - generic [ref=e504]:
                    ...
                    - list [ref=e506]:
                        - listitem [ref=e507]:
                            - link "Início" [ref=e508] [cursor=pointer]:
                                - /url: "#home"
                        - listitem [ref=e509]:
                            - link "Projetos" [ref=e510] [cursor=pointer]:
                                - /url: "#projects"
                        - listitem [ref=e511]:
                            - link "Experiência" [ref=e512] [cursor=pointer]:
                                - /url: "#experience"
                        - listitem [ref=e513]:
                            - link "Habilidades" [ref=e514] [cursor=pointer]:
                                - /url: "#skills"
                        - listitem [ref=e515]:
                            - link "Contato" [ref=e516] [cursor=pointer]:
                                - /url: "#contact"
                        - listitem [ref=e517]:
                            - link "Usado neste site" [ref=e518] [cursor=pointer]:
                                - /url: "#tech-stack"
                - generic [ref=e519]:
                ...
                - generic [ref=e528]:
                    ...
                    - list [ref=e530]:
                        - listitem [ref=e531]:
                            - link "E-mail Profissional" [ref=e532] [cursor=pointer]:
                                - /url: mailto:contato@rogeriodocarmo.com
                                - img [ref=e533]
                                - generic [ref=e536]: contato@rogeriodocarmo.com
                        - listitem [ref=e537]:
                            - link "Baixar currículo em formato PDF" [ref=e538] [cursor=pointer]:
                                - /url: /resumes/resume.pdf
                                - img [ref=e539]
                                - generic [ref=e541]: Baixar Currículo
                        - listitem [ref=e542]:
                            - link "Baixar dissertação de mestrado em formato PDF" [ref=e543] [cursor=pointer]:
                                - /url: /academic/masters_degree_dissertation_rogerio_do_carmo.pdf
                                - img [ref=e544]
