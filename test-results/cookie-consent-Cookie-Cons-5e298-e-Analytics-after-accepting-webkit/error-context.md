...
- Name: cookie-consent.spec.ts >> Cookie Consent Banner >> Accept all flow >> should enable Firebase Analytics after accepting
- Location: tests/e2e/cookie-consent.spec.ts:114:9
