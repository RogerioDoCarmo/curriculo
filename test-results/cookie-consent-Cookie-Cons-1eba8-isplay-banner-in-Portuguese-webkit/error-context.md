...
```
Error: page.goto: Navigation to "http://localhost:3000/pt-BR" is interrupted by another navigation to "http://localhost:3000/pt-BR/"
Call log:
  - navigating to "http://localhost:3000/pt-BR", waiting until "load"
