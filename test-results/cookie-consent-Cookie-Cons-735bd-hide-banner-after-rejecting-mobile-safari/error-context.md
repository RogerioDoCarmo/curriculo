...
- Name: cookie-consent.spec.ts >> Cookie Consent Banner >> Reject non-essential flow >> should hide banner after rejecting
- Location: tests/e2e/cookie-consent.spec.ts:133:9
