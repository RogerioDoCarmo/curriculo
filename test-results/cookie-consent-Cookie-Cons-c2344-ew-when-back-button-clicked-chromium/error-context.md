...
- Name: cookie-consent.spec.ts >> Cookie Consent Banner >> Customize flow >> should return to main view when back button clicked
- Location: tests/e2e/cookie-consent.spec.ts:332:9
...
Locator: getByRole('dialog', { name: /cookies|privacidade/i }).getByText(/personalizar|customize preferences/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: /cookies|privacidade/i }).getByText(/personalizar|customize preferences/i)
...
- generic [active] [ref=e1]:
    ...
    - dialog [ref=e572]:
        - generic [ref=e573]:
            - generic [ref=e574]:
                - button "Voltar" [ref=e575] [cursor=pointer]:
                    - img [ref=e576]
                - heading "Personalizar Preferências de Cookies" [level=2] [ref=e578]
            - paragraph [ref=e579]: Escolha quais categorias de cookies você deseja permitir. Cookies essenciais não podem ser desativados.
            - generic [ref=e580]:
                - generic [ref=e581]:
                    - generic [ref=e582]:
                        - generic [ref=e583]:
                            - heading "Cookies Essenciais" [level=3] [ref=e584]
                            - generic [ref=e585]: Obrigatório
                        - paragraph [ref=e586]: Necessários para o funcionamento básico do site (tema, idioma, sessão). Sempre ativos.
                    - checkbox "Cookies Essenciais" [checked] [disabled] [ref=e588]
                - generic [ref=e589]:
                    - generic [ref=e590]:
                        - heading "Cookies de Análise" [level=3] [ref=e591]
                        - paragraph [ref=e592]: Ajudam a entender como os visitantes interagem com o site através do Firebase Analytics. Dados anônimos.
                        - paragraph [ref=e593]: "Cookies: _ga, _ga_<container-id>, _gid, _gat"
                    - checkbox "Cookies de Análise" [ref=e595]
                - generic [ref=e596]:
                    - generic [ref=e597]:
                        - heading "Cookies Funcionais" [level=3] [ref=e598]
                        - paragraph [ref=e599]: Melhoram a experiência do usuário com recursos adicionais (notificações, preferências).
                    - checkbox "Cookies Funcionais" [ref=e601]
            - button "Salvar Preferências" [ref=e603] [cursor=pointer]
```
